...
<html>
    <head>
        ...
        <title>PERFIL USUARIO DE ADMINISTRACION GESTICOLE: PROFESORES</title>
        ...
        <div class="container-fluid">
                ...
                <div class="container">
                    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                        <h1 class="page-header">ADMINISTRACION GESTICOLE</h1>
...
FFABRRRQB+s//BDn/kWfi7/1+aZ/6Bc1+oNfl9/wQ5/5Fn4u/wDX5pn/AKBc1+oNAH//2Q==" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
                                </a><h4>Alumnos</h4>
                            </div>
                            <div class="col-xs-6 col-sm-3 placeholder">
                            <a href="../02.php">
...
// Listado /////////////////////////////////////////////////
                        ...
                        <table  class="table table-striped">
                            ...
                            <tr><td>Página <?= $_SESSION['pagina'] ?> de <?= $numPaginas ?></td>
                                ...
                                <td>
                                    <form action="pagina.php" method="post">
                                        <input type="hidden" name="ejercicio" value="02_2">

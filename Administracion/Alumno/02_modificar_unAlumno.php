...
<div class="container">
    <div class="panel panel-primary">
        <div class="panel-heading">
            ...
            Modificación de datos del alumno seleccionado:
        </div>
        <div class="panel-body">
            <form action="pagina.php" method="post">
                ...
                Colegio: <input type="text" name="colegio" value="<?= $colegio ?>" size="60" required="required"><br>
                Edad: <input type="text" name="edad" value="<?= $edad ?>" size="60" required="required"><br>
